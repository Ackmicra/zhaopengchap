...
public class PlanTrans2201Service {
	...
	*/  
	public JdResponseView request2201(String brNo, String tradeNo, List<JdRepayPlanData> JdRepayPlanDataList) {
		//拼发送小微业务数据
	...
	* @throws
	 */
	public JdResponseView request2201ForChange(String brNo, String tradeNo, List<JdRepayPlanData> jdRepayPlanDataList,
