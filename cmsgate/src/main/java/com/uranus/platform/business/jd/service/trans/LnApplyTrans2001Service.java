...
//		}
	...
	private List<Request2001ListDto> Assemble(String prdtNo, JdLoanApplyInfoData jdLoanApplyInfoData, JdLoanUserData jdLoanUserData, List<JdRelationUserData> jdRelationUserDataList){
		...
		for (int i = 0; i < jdRelationUserDataList.size(); i++) {
			...
			//年收入判断
			if(b1.multiply(new BigDecimal(12)).doubleValue()>0&&b1.multiply(new BigDecimal(12)).doubleValue()<=200000.00) {
				cblistDto.setIncome("01");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>200000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=500000.00) {
				cblistDto.setIncome("02");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>500000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=1000000.00) {
				cblistDto.setIncome("03");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>1000000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=3000000.00) {
				cblistDto.setIncome("04");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>3000000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=10000000.00) {
				cblistDto.setIncome("05");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>10000000.00) {
				cblistDto.setIncome("06");
			}
			//家庭年收入
			if(cblistDto.getZxhomeIncome()>0&&cblistDto.getZxhomeIncome()<=200000.00) {
				cblistDto.setHomeIncome("01");
			}else if(cblistDto.getZxhomeIncome()>200000.00&&cblistDto.getZxhomeIncome()<=500000.00) {
				cblistDto.setHomeIncome("02");
			}else if(cblistDto.getZxhomeIncome()>500000.00&&cblistDto.getZxhomeIncome()<=1000000.00) {
				cblistDto.setHomeIncome("03");
			}else if(cblistDto.getZxhomeIncome()>1000000.00&&cblistDto.getZxhomeIncome()<=3000000.00) {
				cblistDto.setHomeIncome("04");
			}else if(cblistDto.getZxhomeIncome()>3000000.00&&cblistDto.getZxhomeIncome()<=10000000.00) {
				cblistDto.setHomeIncome("05");
			}else if(cblistDto.getZxhomeIncome()>10000000.00) {
				cblistDto.setHomeIncome("06");
			}
	...
	private List<Request2001ListDto> Assemble2(String prdtNo, JdLoanApplyInfoData jdLoanApplyInfoData, JdLoanUserData jdLoanUserData){
		...
		// List(All)
			...
			if(b1.multiply(new BigDecimal(12)).doubleValue()>0&&b1.multiply(new BigDecimal(12)).doubleValue()<=200000.00) {
				...
				cblistDto.setIncome("02");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>500000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=10000000.00) {
				cblistDto.setIncome("03");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>10000000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=30000000.00) {
				cblistDto.setIncome("04");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>3000000.00&&b1.multiply(new BigDecimal(12)).doubleValue()<=100000000.00) {
				cblistDto.setIncome("05");
			}else if(b1.multiply(new BigDecimal(12)).doubleValue()>10000000.00) {
				cblistDto.setIncome("06");
			}
			...
			if (response != null) {
				...
				if (CmsBusinessStatus.MFS_SUCCESS.businessCode().equals(response.getRespCode())) {
					 ...
					 */
					 ...
					 message.setTaskData(mapEntry.get("applicationNo"));
					 message.setTaskType(CmsBusinessStatus.CALLBACK_AUDIT_RESULT.businessCode());
					...
					if(response2001 != null && response2001.getList().size() >0) {
						auditReason = response2001.getList().get(0).getDealDesc();
					}
					List<String> list = new ArrayList<String>();
					list.add(auditReason);
